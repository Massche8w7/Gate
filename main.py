...
client_token = '7313411308:AAHNyPkFJVxrM5S9QiMFsixI2V6Lv4YtknY'

admin_ids = [6997944818]  # Example admin IDs
        ...
        if '.' in rw:
            ...
            if not website_url.startswith(("http://", "https://")):
                ...
                if "Error" in payment_gateways:
                    ...
                    await edit.edit(f""" ┏━━━━━━━⍟\n┃ 𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻 𝗳𝗲𝘁𝗰𝗵𝗲𝗱 ✅\n┗━━━━━━━━━━━━⊛\n 𝗦𝗶𝘁𝗲 -» `{domain}`\n• 𝗚𝗮𝘁𝗲𝘄𝗮𝘆𝘀 ➜ unknown\n━━━━━━━━━━━━━━━\n[◈](https://i.ibb.co/CMcdMjf/Blue-Tosca-Geometric-Technology-Linkedln-Banner.png) 𝐓𝐢𝐦𝐞 𝐓𝐚𝐤𝐞𝐧 : `{rounded_time_taken}``s`\n[◈](https://i.ibb.co/CMcdMjf/Blue-Tosca-Geometric-Technology-Linkedln-Banner.png) 𝐁𝐨𝐭 [𝗚𝗮𝘁𝗲𝘄𝗮𝘆 𝗟𝗼𝗼𝗸𝘂𝗽V2](https://t.me/GatewayLookupV10Bot)\n❝ ━━━━・{ch}・━━━━ ❞""")
                else:
